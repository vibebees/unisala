    ...
    <>
      <IonRow className=" !px-0 border  h-full rounded-md border-neutral-300 border-opacity-75 pt-2">
        <IonCol className="w-full h-full  px-0">
          ...
          <div className="   bottom-0 h-10 w-full  px-4 bg-gradient-to-t from-neutral-300 to-transparent border-opacity-25 items-baseline border-op justify-start flex">
