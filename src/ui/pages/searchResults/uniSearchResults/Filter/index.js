            ...
            <IonCardContent>
                ...
                <div className="search-control">
                    ...
                    <div className="field search-field">
                        ...
                        >
                            <IonSelectOption value="any">Any</IonSelectOption>
                            <IonSelectOption value="catholic">
                                Catholid
                            </IonSelectOption>
                            <IonSelectOption value="christian">
                                Christian
                            </IonSelectOption>
                            <IonSelectOption value="jewish">
                                Jewish
                            </IonSelectOption>
                        </IonSelect>
                    </div>
                ...
                <div className="search-control">
                    ...
                    <div className="field search-field">
                        ...
                        >
                            <IonSelectOption value="any">Any</IonSelectOption>
                            <IonSelectOption value="$65,000+">
                                $65,000+
                            </IonSelectOption>
                            <IonSelectOption value="$55,000+">
                                $55,000+
                            </IonSelectOption>
                            <IonSelectOption value="$45,000+">
                                $45,000+
                            </IonSelectOption>
                            <IonSelectOption value="$35,000+">
                                $35,000+
                            </IonSelectOption>
                            <IonSelectOption value="$25,000+">
                                $25,000+
                            </IonSelectOption>
                        </IonSelect>
                    </div>
