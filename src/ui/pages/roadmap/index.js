    ...
    <IonContent className="roadmap-background1">
      <IonGrid style={{ maxWidth: "700px", margin: "auto" }}>
        <IonRow>
          <IonCol>
            <img
              src="https://icsblog.s3.ap-south-1.amazonaws.com/blog/wp-content/uploads/2023/05/10171257/study-abroad-usa.jpg"
        ...
        <IonRow>
          <IonCol>
            <img
              src="https://i.ibb.co/BPjHZby/prashantbasnet94-happineess-and-exitement-in-Nepalese-student-f-c6dc665d-6e44-45c1-a807-0ac59a0fac93.png"
              alt="Study Abroad Roadmap"
              className="roadmap-banner"
            />
          </IonCol>
