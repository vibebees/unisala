      ...
      >
              ...
              {[
                {
                  ...
                  value: uniData?.grants?.aid?.pellGrant?.averageAmount
                },
                {
                  titles: "Federal Grants",
                  title: "Average Amount",
                  value: uniData?.grants?.aid?.federalGrants?.averageAmount
                },
                {
                  titles: "General",
                  title: "Average Amount",
                  value: uniData?.grants?.aid?.general?.averageAmount
                },
                {
                  titles: "State Grants",
                  title: "Average Amount",
                  value: uniData?.grants?.aid?.stateGrants?.averageAmount
                }
              ].map((item, index) => {
                return (
                  <IonCol
        ...
        <IonGrid>
          <IonRow>
            ...
            >
              {grantAnimate &&
              uniData?.grants?.aid?.pellGrant?.percentageReceivingAid !== -1 ? (
                <>
                  <CircularBar
                    value={`${useIsData(
                      uniData?.grants?.aid?.pellGrant?.percentageReceivingAid
                    )}`}
                  />
                  <IonText
                    style={{
